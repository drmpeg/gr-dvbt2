...
# Title: Vv005 4Kfft
# Generated: Mon Nov 17 21:22:20 2014
##################################################
...
class vv005_4kfft(grc_wxgui.top_block_gui):

    def __init__(self):
        grc_wxgui.top_block_gui.__init__(self, title="Vv005 4Kfft")
        ...
        self.dvbt2_pilotgenerator_cc_0 = dvbt2.pilotgenerator_cc(dvbt2.CARRIERS_EXTENDED, dvbt2.FFTSIZE_8K_NORM, dvbt2.PILOT_PP8, 59, 8192)
        self.dvbt2_p1insertion_cc_0 = dvbt2.p1insertion_cc(dvbt2.CARRIERS_EXTENDED, dvbt2.FFTSIZE_8K_NORM, dvbt2.GI_1_16, 59, (window.rectangular(1024)))
        ...
        self.dvbt2_freqinterleaver_cc_0 = dvbt2.freqinterleaver_cc(dvbt2.CARRIERS_EXTENDED, dvbt2.FFTSIZE_8K_NORM, dvbt2.PILOT_PP8, 59)
        self.dvbt2_framemapper_cc_0 = dvbt2.framemapper_cc(dvbt2.FECFRAME_NORMAL, dvbt2.C3_5, dvbt2.MOD_256QAM, dvbt2.ROTATION_ON, 50, 3, dvbt2.CARRIERS_EXTENDED, dvbt2.FFTSIZE_8K_NORM, dvbt2.GI_1_16, dvbt2.L1_MOD_64QAM, dvbt2.PILOT_PP8, 2, 59)
