...
# Title: Vv001 Cr35
# Generated: Mon Nov 17 20:38:46 2014
##################################################
...
class vv001_cr35(grc_wxgui.top_block_gui):

    def __init__(self):
        grc_wxgui.top_block_gui.__init__(self, title="Vv001 Cr35")
        ...
        self.fft_vxx_0 = fft.fft_vcc(32768, False, (window.rectangular(32768)), True, 1)
        self.dvbt2_pilotgenerator_cc_0 = dvbt2.pilotgenerator_cc(dvbt2.CARRIERS_EXTENDED, dvbt2.FFTSIZE_32K_SGI, dvbt2.PILOT_PP7, 59, 32768)
        self.dvbt2_p1insertion_cc_0 = dvbt2.p1insertion_cc(dvbt2.CARRIERS_EXTENDED, dvbt2.FFTSIZE_32K_SGI, dvbt2.GI_1_128, 59, (window.rectangular(1024)))
        ...
        self.dvbt2_freqinterleaver_cc_0 = dvbt2.freqinterleaver_cc(dvbt2.CARRIERS_EXTENDED, dvbt2.FFTSIZE_32K_SGI, dvbt2.PILOT_PP7, 59)
        self.dvbt2_framemapper_cc_0 = dvbt2.framemapper_cc(dvbt2.FECFRAME_NORMAL, dvbt2.C3_5, dvbt2.MOD_256QAM, dvbt2.ROTATION_ON, 202, 3, dvbt2.CARRIERS_EXTENDED, dvbt2.FFTSIZE_32K_SGI, dvbt2.GI_1_128, dvbt2.L1_MOD_64QAM, dvbt2.PILOT_PP7, 2, 59)
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, "/home/re/xfer/vvcr35.ts", True)
